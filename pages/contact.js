  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Twandikire: burundicrochet@gmail.com. Dushobora kandi kukubona i Gihosha, Bujumbura." />
      </Head>
      <main className="py-12">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h1 className="text-2xl font-display mb-4">Twandikire</h1>
            <p className="text-gray-700 mb-4">Ushobora kutwandikira kuri email: <a className="text-brandGreen underline" href="mailto:burundicrochet@gmail.com?subject=Kubaza%20ku%20bicuruzwa">burundicrochet@gmail.com</a></p>
